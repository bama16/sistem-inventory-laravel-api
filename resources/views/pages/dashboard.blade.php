                                ...
                                <div class="card-body py 4">
                                    <div class="d-flex align-item-start">
                                        <div class="flex-grown-1">
                                            <h5 class="mb2">Jumlah Barang Masuk</h5>
                        ...
                        <div class="col-12 d-flex">
                            <div class="card flex-fill border-0 kotak">
                                <div class="card-body py 4">
                                    <div class="d-flex align-item-start">
                                        <div class="flex-grown-1">
                                            <h5 class="mb2">Jumlah Barang Keluar</h5>
                        ...
                        <div class="col-12 d-flex">
                            <div class="card flex-fill border-0 kotak">
                                <div class="card-body py 4">
                                    <div class="d-flex align-item-start">
                                        <div class="flex-grown-1">
                                            <h5 class="mb2">Jumlah Supplier</h5>
...
<script>
    ...
    var categories = @json($itemCountsCategory->pluck('kategori'));
    var itemCounts = @json($itemCountsCategory->pluck('count'));
