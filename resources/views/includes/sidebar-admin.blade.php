            ...
            <li class="sidebar-item">
                ...
                <li class="sidebar-item">
                    <a href="{{ route('usermanagement.index') }}" class="sidebar-link">
                        <img width="24" height="24" src="/images/adduser.png" alt="truck" style="margin-right: 2px; margin-left: 1px;"/>
                        User Management
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="{{ route('datapimpinan.index') }}" class="sidebar-link">
                        <img width="24" height="24" src="/images/pimpinan.png" alt="truck" style="margin-right: 2px; margin-left: 1px;"/>
                        Data Pimpinan
                    </a>
                </li>
                <li class="sidebar-item">
                    <a href="{{ route('dataoperator.index') }}" class="sidebar-link">
                        <img width="24" height="24" src="/images/operator.png" alt="truck" style="margin-right: 2px; margin-left: 1px;"/>
                        Data Operator
                    </a>
                </li>
            </li>
